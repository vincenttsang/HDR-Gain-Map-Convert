...
class Converter {
    ...
    init(src: String, dest: String, imageQuality: Double, colorSpace: String, colorDepth: Int, SDR: Bool, PQ: Bool, HLG: Bool) {
        self.src = src
        self.dest = dest
    ...
    func convert() -> Int {
        ...
        case "rec2020","2020","rec.2020","bt2020","itu2020","2100","rec2100","rec.2100":
            ...
            hlg_color_space = CGColorSpace.itur_2100_HLG
        default:
            debugPrint("Error: The colorSpace argument requires color space argument. (srgb, p3, rec2020)")
        }
